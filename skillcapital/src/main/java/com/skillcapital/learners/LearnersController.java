...
public class LearnersController {
    ...
    // Get learners by first name and last name (case-insensitive)
    @GetMapping("/name")
    public List<Learners> getLearnersByName(@RequestParam String firstName, @RequestParam String lastName) {
        return learnersService.getLearnersByName(firstName, lastName);
    }
