...
public class LearnersService {
    ...
    public String registerLearner(Learners learner) {
        ...
        Optional<Learners> existingLearner = learnersRepository
                .findByFirstNameAndLastNameAndEmailIgnoreCase(
                        learner.getFirstName(), learner.getLastName(), learner.getEmail());
    ...
    public List<Learners> getLearnersByName(String firstName, String lastName) {
        return learnersRepository.findByFirstNameAndLastNameIgnoreCase(firstName, lastName);
    }
    ...
    public Learners updateLearner(Long id, Learners newLearner) {
        return learnersRepository.findById(id)
                .map(learner -> {
                    learner.setFirstName(newLearner.getFirstName());
                    learner.setLastName(newLearner.getLastName());
